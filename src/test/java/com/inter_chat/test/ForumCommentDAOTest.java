...
//	@Ignore
	...
	public void listBlogCommentTest() {
		List<ForumComment> listForumComment = forumCommentDAO.listForumComment(0);
		assertTrue("Problem in listing forum:", listForumComment.size() > 0);
		for (ForumComment forumComment : listForumComment) {
			System.out.println(
					forumComment.getForumId() + ": " + forumComment.getCommentId() + ": " + forumComment.getLoginName()
							+ ":" + forumComment.getCommentText() + ":" + forumComment.getCommentDate());
		}
	}
}